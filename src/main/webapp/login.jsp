...
<div id="loginBox" class="login" style="margin-top:50px;z-index: 2000">
    <div class="header2">
        ...
        <div class="web_login" id="web_login">
            <div class="login-box">
                <div class="login_form">
                    <form action="${pageContext.request.contextPath}/LoginServlet" name="loginform" accept-charset="utf-8" id="login_form" class="loginForm"
    ...
    <div class="qlogin" id="qlogin" style="display: none; ">
        <div class="web_login">
            <form name="form2" id="regUser" accept-charset="utf-8" action="${pageContext.request.contextPath}/RegisterServlet" method="post">
                ...
                <ul class="reg_form" id="reg-ul">
                    ...
                    <li>
                        ...
                        <div class="inputOuter2">
                            <input type="text" id="mail" name="mail" maxlength="30" class="inputstyle2"/>
                        </div>
                    </li>
                    <li>
                        <div class="inputArea">
